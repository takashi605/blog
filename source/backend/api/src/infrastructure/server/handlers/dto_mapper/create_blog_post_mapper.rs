...
use crate::application::usecase::create_blog_post::dto::{
    CreateBlogPostDTO, CreateImageDTO, CreateContentDTO, CreateRichTextDTO, CreateStyleDTO, CreateLinkDTO
};
...
fn api_content_to_create_dto(api_content: api::BlogPostContent) -> CreateContentDTO {
    match api_content {
        api::BlogPostContent::H2(h2) => CreateContentDTO::H2 {
            id: h2.id,
            text: h2.text,
        },
        api::BlogPostContent::H3(h3) => CreateContentDTO::H3 {
            id: h3.id,
            text: h3.text,
        },
...
mod tests {
                ...
                api::BlogPostContent::Paragraph(api::ParagraphBlock {
                    ...
                    text: vec![
                        api::RichText {
                            ...
                            styles: api::Style { bold: false, inline_code: false },
                            link: None,
                        },
                        api::RichText {
                            text: "太字テキスト".to_string(),
                            styles: api::Style { bold: true, inline_code: false },
                            link: None,
                        },
                        api::RichText {
                            text: "リンクテキスト".to_string(),
                            styles: api::Style { bold: false, inline_code: false },
                            link: Some(api::Link { url: "https://example.com".to_string() }),
                        },
                    ],
                }),
    ...
    fn test_api_content_to_create_dto_h2() {
        ...
        let api_content = api::BlogPostContent::H2(api::H2Block {
            id,
            text: text.clone(),
        });
    ...
    fn test_api_content_to_create_dto_h3() {
        ...
        let api_content = api::BlogPostContent::H3(api::H3Block {
            id,
            text: text.clone(),
        });
    ...
    fn test_api_content_to_create_dto_image() {
        ...
        let api_content = api::BlogPostContent::Image(api::ImageBlock {
            id,
            path: path.clone(),
        });
    ...
    fn test_api_content_to_create_dto_code_block() {
        ...
        match dto {
            CreateContentDTO::CodeBlock { id: dto_id, title: dto_title, code: dto_code, language: dto_language } => {
                assert_eq!(dto_id, id);
    ...
    fn test_api_rich_text_to_create_dto() {
        let api_rich_text = api::RichText {
            ...
            link: Some(api::Link { url: "https://test.com".to_string() }),
        };
