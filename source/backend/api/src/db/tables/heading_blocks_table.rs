...
pub async fn fetch_heading_blocks_by_content_id(pool: &PgPool, content_id: Uuid) -> Result<HeadingBlockRecord> {
...
pub async fn insert_heading_block(pool: &PgPool, heading_block: HeadingBlockRecord) -> Result<()> {
