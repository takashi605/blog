 ...
 * データベース操作関数
 */
pub async fn fetch_image_block_record_with_relations<'e, E>(pool: E, content_record_id: Uuid) -> Result<ImageBlockRecordWithRelations>
where
...
pub async fn fetch_image_blocks_by_content_id<'e, E>(pool: E, content_id: Uuid) -> Result<ImageBlockRecord>
where
  E: Executor<'e, Database = Postgres>,
{
...
pub async fn insert_image_block<'e, E>(pool: E,image_block: ImageBlockRecord) -> Result<()>
where
  E: Executor<'e, Database = Postgres>,
{
