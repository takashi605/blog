...
export interface components {
    schemas: {
        ...
        BlogPostContent: (components["schemas"]["H2Block"] & {
            /** @enum {string} */
            type: "h2";
        ...
        CreateBlogPostContentRequest: (components["schemas"]["CreateH2BlockRequest"] & {
            /** @enum {string} */
            type: "h2";
        }) | (components["schemas"]["CreateH3BlockRequest"] & {
            /** @enum {string} */
            type: "h3";
        }) | (components["schemas"]["CreateParagraphBlockRequest"] & {
            /** @enum {string} */
            type: "paragraph";
        }) | (components["schemas"]["CreateImageBlockRequest"] & {
            /** @enum {string} */
            type: "image";
        }) | (components["schemas"]["CreateCodeBlockRequest"] & {
            /** @enum {string} */
            type: "codeBlock";
        });
        CreateBlogPostRequest: {
            contents: components["schemas"]["CreateBlogPostContentRequest"][];
            /** Format: date */
            lastUpdateDate: string;
            /** Format: date */
            postDate: string;
        ...
        CreateH2BlockRequest: {
            text: string;
        };
        CreateH3BlockRequest: {
            text: string;
        };
