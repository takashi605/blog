...
import { ViewPopularPostUseCase } from './viewPopularBlogPosts';

describe('viewPopularPosts', () => {
  it('人気記事のエンティティデータを閲覧できる', async () => {
    const expectedPopularPost: BlogPostDTO[] = buildPopularPostsDTOMock();
...
function buildPopularPostsDTOMock(): BlogPostDTO[] {
