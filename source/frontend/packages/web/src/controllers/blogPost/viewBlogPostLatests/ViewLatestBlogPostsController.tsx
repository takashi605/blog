...
async function ViewLatestBlogPostsController({quantity}: ViewLatestBlogPostsControllerProps) {
  ...
  const viewLatestsUseCase = new ViewLatestBlogPostsUseCase(blogPostRepository).setQuantity(quantity);
