...
import { ViewPopularPostUseCase } from './viewPopularPost';

describe('viewPopularPost', () => {
  it('人気記事のエンティティデータを閲覧できる', async () => {
    const expectedPopularPost: BlogPostDTO[] = buildPopularPostDTOMock();
    ...
    const usecase = new ViewPopularPostUseCase(mockRepository).setQuantity(3);
...
function buildPopularPostDTOMock(): BlogPostDTO[] {
