Feature: 記事投稿
  Scenario: 【正常系 記事投稿】記事を投稿する
    ...
    When 【正常系 記事投稿】「リンクテスト」という文字を入力・選択し、リンクボタンを押す
    Then 【正常系 記事投稿】リンク設定 input が出現する
    When 【正常系 記事投稿】リンク設定 input に「example.com」と入力する
    ...
    When 【正常系 記事投稿】数行のコードを入力し、「code」ボタンを押す
    ...
    When 【正常系 記事投稿】「画像の直後」という文字列を入力する
    Then 【正常系 記事投稿】リッチテキストエディタに「画像の直後」という文字列が表示されている
    ...
    Then 【正常系 記事投稿】「リンクテスト」という文字のリンクが存在する
    Then 【正常系 記事投稿】「リンクテスト」の href が「example.com」になっている
    ...
    Then 【正常系 記事投稿】コードブロック内に入力した内容が表示されている
    Then 【正常系 記事投稿】コードのコピーボタンが表示されている
    Then 【正常系 記事投稿】画像が表示されている
    Then 【正常系 記事投稿】画像の直後に「画像の直後」という文字列が表示されている
